...
<span style="color: #a9c056">•	Зеленый цвет текста </span> означает что вопрос удачно прошел модерацию и опубликован на сайте.<br>
<span style="color: orange">•	Оранжевый цвет текста </span> означает что вопрос находится на модерации и еще не проверен администратором / модератором системы.<br>
<span style="color: red">•	Красный цвет тексты </span> означает что вопрос не прошел модерацию, был отклонен и не будет опубликован на сайте.<br>
